...
%$\sqdet [B_{\phi}^{n,\hatr}]_{\hatr-1}$ of the square $(\hatr - 1) \times (\hatr - 1)$ upper submatrix $[B_{\phi}^{n,\hatr}]_{\hatr-1}$ of $B_{\phi}^{n,\hatr}$. 
...
\begin{lemma}
$\deg_{\alpha_{i,j}} \sqdet B_{\phi}^{n,\hatr} \leq 2nr^2$.
\end{lemma}

...
The following approach is due to \cite{GaraiPapikian}. Rewrite the expression for the minimal polynomial as $f_i' + f_i = 0$ where
...
\phi_x^u\tau^{n} & \phi_x^u\tau^{2n} & \ldots & \phi_x^u\tau^{n\lfloor r - (ur)/n \rfloor} \\
\phi_x^u\tau^{2n} & \phi_x^u\tau^{3n} & \ldots & \phi_x^u\tau^{(1 +\lfloor r - (ur)/n \rfloor)n} \\ \vdots & \vdots & \ddots & \vdots \\ \phi_x^u\tau^{vn} & \phi_x^u\tau^{(1+v)n} & \ldots & \phi_x^u\tau^{(v + \lfloor r - (ur)/n \rfloor) n}
\end{bmatrix}
\end{equation*}
\begin{equation*}
    G_{v} = \begin{bmatrix}
